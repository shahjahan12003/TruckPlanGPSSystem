...
namespace TruckPlanApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UserApiResult :  IEquatable<UserApiResult>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UserApiResult);
        }

        /// <summary>
        /// Returns true if UserApiResult instances are equal
        /// </summary>
        /// <param name="input">Instance of UserApiResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserApiResult input)
        {
            if (input == null)
                return false;
