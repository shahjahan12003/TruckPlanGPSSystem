...
namespace TruckPlanApi.Controllers.v1
{
    ...
    public class UsersController : BaseController
    {
        ...
        {
            logger.LogError("The Create method was called");
            HttpContext.RiseError(new Exception("متدThe Create method was called"));
            ...
            var user = new User
            {
                ...
                GPSDeviceID = userDto.GPSDeviceID,
        ...
        public virtual async Task<ApiResult> Update(int id, User user, CancellationToken cancellationToken)
        {
            ...
            updateUser.GPSDeviceID = user.GPSDeviceID;
